...
> 原理：最优子结构性质：存在原问题和若干**相同独立**子问题之间的**关系**
>
> 变化：函数参数和返回值；递归终止条件；最优子结构对应的递归逻辑



### 回溯

> 原理：组合/切割/子集/排列问题抽象为**树形结构**的==穷举==
>
> 变化：剪枝
>
> ```c++
...
![image-20240729205635655](img/image-20240729205635655.png)
...
就是要在后面的“>”之间，必须得有一个空格，如果有多层，那每层都得有一个空格。L
